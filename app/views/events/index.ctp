<div class="events index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('facebook_event');?></th>
			<th><?php echo $this->Paginator->sort('google_calendar');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $this->Html->link($event['Response']['name'], array('controller' => 'responses', 'action' => 'view', $event['Response']['id'])); ?>
		</td>
		<td><?php echo $event['Event']['facebook_event']; ?>&nbsp;</td>
		<td><?php echo $event['Event']['google_calendar']; ?>&nbsp;</td>
