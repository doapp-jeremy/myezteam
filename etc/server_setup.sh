...
sudo apt-get install --assume-yes --force-yes ec2-api-tools php-apc php5-memcached php5-memcache php5-cli php5-dev php5-common php5-curl php5-mcrypt php5-mysql php-pear subversion php5-suhosin ec2-api-tools nginx-full php5-fpm capistrano rubygems rubygems1.9.1 rubygems1.8 libpcre3-dev git postifx monit memcached
